    ...
    <div class="haeder__container">
      <div class="header__inner">
        <div class="header-top">
          ...
          <div class="header-top__item header-top__item--mobile" v-click-outside="hide">
            <div class="header-top__burger" @click="menuOpen" :class="{ 'is-open': isOpenMenu }">
              <span></span>
              <span></span>
              <span></span>
            </div>
            <div class="header-top__drop" :class="{ 'is-open': isOpenMenu }">
              ...
              <div class="header-mobile__more header-more">
                ...
                <a href="mailto:info@codeseven.ru" class="btn btn-light">Написать нам</a>
              </div>
            </div>
          </div>
          <div class="header-top__item">
      ...
      menu: [
        {
          ...
          url: 'https://zettains.ru/upload/rules/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0%20%D0%9E%D0%A1%D0%93%D0%9E%D0%9F%20%D0%BD%D0%B0%20%D1%81%D0%B0%D0%B9%D1%82.pdf',
        },
        {
          name: 'Страховая деятельность',
          url: 'https://zettains.ru/vss_info/#_ga=2.234079454.1387420564.1736426837-270621958.1735288439',
        },
        {
          name: 'Образец договора страхования',
          url: 'https://zettains.ru/local/modules/zetta.calc/lib/Pdf/osgop/files/obrazec_osgop.pdf',
        },
        {
